    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null) {
                ...
                String txtSatus = request.getParameter("txtSatus");
                String txtCategory = request.getParameter("txtCategory");

                ProductDTO productDTO = new ProductDTO();
                productDTO.setId(Integer.parseInt(txtId));
                ...
                productDTO.setIsActive(Boolean.parseBoolean(txtSatus));
                productDTO.setCategoryId(Integer.parseInt(txtCategory));
                if(!imgUrl.trim().isEmpty()){
                    productDTO.setImage(UPLOAD_DIR + "/" + imgUrl);
                }                

                ProductDAO productDAO = new ProductDAO();
                productDAO.updateProduct(productDTO, user.getId());
            }
        } catch (SQLException ex) {
            log("UpdateProductServlet_SQLException: " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
            log("UpdateProductServlet_ClassNotFoundException: " + ex.getMessage());
    ...
    private String uploadFile(HttpServletRequest request) throws IOException, ServletException {
        ...
        try {
            ...
            try {
                ...
                log("UpdateProductServlet_SQLException: " + e.getMessage());
                fileName = "";
            } finally {
                if (inputStream != null) {
                    inputStream.close();
